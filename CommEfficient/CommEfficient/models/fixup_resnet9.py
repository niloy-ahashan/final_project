...
from .fixup_resnet import FixupBasicBlock, conv3x3
...
class FixupResNet9(nn.Module):
    def __init__(self, channels=None, pool=nn.MaxPool2d(2), num_classes=10, **kwargs):
        super().__init__()
        self.num_layers = 2
        self.channels = channels or {"prep": 64, "layer1": 128,
                                     "layer2": 256, "layer3": 512}
        ...
        self.pool = nn.MaxPool2d(4)
        self.bias2 = nn.Parameter(torch.zeros(1))
        self.linear = nn.Linear(self.channels["layer3"], num_classes)
